...
// Do NOT require env vars at module load. If any var is missing, requiring this file
// would throw and the whole /api/auth serverless bundle returns HTML 500 (no JSON),
// which breaks login with a generic "server unavailable" message on the client.
// Validation stays in isOwnerAuthConfigured(), verifyOwnerCredentials(), and generateToken().
